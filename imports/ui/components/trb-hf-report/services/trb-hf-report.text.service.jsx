...
export default function TrbHfReport_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbHfReport_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbHfReport_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbHfReport_Text_Service
    }
}
