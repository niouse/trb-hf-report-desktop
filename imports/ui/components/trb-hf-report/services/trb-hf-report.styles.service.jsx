...
export default function TrbHfReport_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $TrbHfReport_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbHfReport_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbHfReport_Styles_Service
    }
} 
