...
import Component from "./../trb-hf-report.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbHfReport_Styles_Service} from "./../services/trb-hf-report.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-hf-report.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-hf-report-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-hf-report-" + key)
