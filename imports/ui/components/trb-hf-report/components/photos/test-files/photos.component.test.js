...
import Component from "./../photos.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {Photos_Styles_Service} from "./../services/photos.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (photos.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("photos-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("photos-" + key)
