...
export default function Photos_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $Photos_Styles_Service extends Component {
            constructor(props) {
                super(props)
