...
import Component from "./../reports.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {Reports_Styles_Service} from "./../services/reports.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (reports.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("reports-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("reports-" + key)
