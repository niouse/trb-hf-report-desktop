...
export default function Reports_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $Reports_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $Reports_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $Reports_Text_Service
    }
}
