...
export default function Reports_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $Reports_Styles_Service extends Component {
            constructor(props) {
                super(props)
