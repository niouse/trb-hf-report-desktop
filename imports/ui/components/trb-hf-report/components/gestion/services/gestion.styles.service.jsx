...
export default function Gestion_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $Gestion_Styles_Service extends Component {
            constructor(props) {
                super(props)
