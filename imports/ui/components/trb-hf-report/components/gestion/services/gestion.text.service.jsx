...
export default function Gestion_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $Gestion_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $Gestion_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $Gestion_Text_Service
    }
}
