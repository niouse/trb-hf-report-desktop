...
import Component from "./../gestion.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {Gestion_Styles_Service} from "./../services/gestion.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (gestion.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("gestion-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("gestion-" + key)
