...
export default function Stats_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $Stats_Styles_Service extends Component {
            constructor(props) {
                super(props)
