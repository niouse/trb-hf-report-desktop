...
export default function Navigation_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $Navigation_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $Navigation_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $Navigation_Styles_Service
    }
} 
