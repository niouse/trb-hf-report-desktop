...
export default function Sites_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $Sites_Styles_Service extends Component {
            constructor(props) {
                super(props)
