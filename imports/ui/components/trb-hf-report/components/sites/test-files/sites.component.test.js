...
import Component from "./../sites.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {Sites_Styles_Service} from "./../services/sites.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (sites.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("sites-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("sites-" + key)
